...
```{r cbbinom-vs-bbinom, fig.width=7, fig.height=5, fig.dpi=192}
...
For larger sizes, you may need higher precision than double to compute the underlying generalized hypergeometric function, at the cost of computational speed.

```{r cbbinom-prec, fig.width=7, fig.height=5, fig.dpi=192}
